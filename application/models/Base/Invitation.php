 ...
 */
abstract class Model_Base_Invitation extends Doctrine_Record
{
    ...
    public function setUp()
    {
        ...
        $this->hasOne('Model_User as InvitedBy', array(
             'local' => 'invitedBy',
             'foreign' => 'id'));
