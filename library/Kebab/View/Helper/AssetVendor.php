...
class Kebab_View_Helper_AssetVendor extends Kebab_View_Helper_Asset
{
    ...
    public function get($vendor, $clearDebug = false)
    {
        ...
        $cdn  = $config->$vendor->cdn 
                    ? $config->$vendor->cdn
                    : $this->_config->assets->loading->cdn->url . DIRECTORY_SEPARATOR . $this->_config->assets->path . DIRECTORY_SEPARATOR . 'vendors';
    ...
    protected function _root($root, $cdn)
    {
        return $this->_config->assets->loading->mode == 'local'
                ? WEB_PATH . DIRECTORY_SEPARATOR . $this->_config->assets->path . DIRECTORY_SEPARATOR . 'vendors' . DIRECTORY_SEPARATOR . $root
                : $cdn . DIRECTORY_SEPARATOR . $root;
    }
}
