...
KebabOS.applications.snake.application.layouts.Layout = Ext.extend(Ext.Panel, {
    ...
    initComponent: function() {
        ...
        Ext.apply(this, {
            items: [
                {
                    html: '<object width="100%" height="100%"><param name="wmode" value="opaque"><param name="movie" value="http://www.neave.com/games/snake/snake.swf"><embed src="http://www.neave.com/games/snake/snake.swf" width="100%" height="100%"> </embed> </object>'
                }
            ]
        });
